...
![Pseudo-proliferation index figure](research_omicsanalysis_proliferation.png)  
...
Another prominent PTM is lysine acetylation, which has been a focus of the Choudhary group at CPR. We have collaborated with them to analyze proteomics data on lysine acetylation (Schölz et al., 2015b) as well as deacetylation (Weinert et al., 2017). We have worked with the Nielsen group on analysis of several other PTMs, namely arginine methylation (Sylvestersen et al., 2014), SUMOylation (Hendriks et al., 2017, 2018), and ADP-ribosylation (Larsen et al., 2018). Most recently, we worked with the Olsen group on analysis of N-terminal acetylation and its effect on thermal stability of proteins (Guzman et al., 2023).
